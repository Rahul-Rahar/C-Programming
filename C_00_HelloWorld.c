...
{
    printf("Hello World!"); // printf() is a function to print or give output on the user or computer screen
    return 0; // return 0 stops the code execution inside the main(){} function.
}
